...
describe('store actif APEX', () => {
  ...
  it('fait primer le suivi automatique sur un ancien bilan manuel devenu obsolète', async () => {
    const { nutritionDay } = await loadStore({
      nutritionDays: {
        '2026-09-11': { kcal: '500', protein: '25', carbs: '60', fat: '12' }
      },
      foodLog: {
        '2026-09-11': [
          { kcal: 620.44, protein: 41.26, carbs: 70.04, fat: 18.28 }
        ]
      }
    })
